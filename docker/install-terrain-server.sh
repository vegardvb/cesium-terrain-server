...
if [ ! -f $archive ]; then
	...
	wget --no-verbose -O $archive "https://github.com/vegardvb/cesium-terrain-server/archive/${checkout}.tar.gz"
fi
...
CTS_DIR=$GOPATH/src/github.com/vegardvb/cesium-terrain-server
mkdir -p $CTS_DIR
